...
namespace Datamart.FunctionalTests.Helpers
{
    ...
    public class DatamartTestFixture<TStartup> : IDisposable where TStartup : class
    {
        private readonly IHost _host;

        public event LogMessage? LoggedMessage;

        public DatamartTestFixture(Action<IServiceCollection>? initialConfigureServices)
        {
        ...
        {
            return new DatamartTestContext<TStartup>(this);
        }
