...
namespace Commission.FunctionalTests.Helpers
{
    ...
    public class CommissionTestFixture<TStartup> : IDisposable where TStartup : class
    {
        private readonly IHost _host;

        public event LogMessage? LoggedMessage;

        public CommissionTestFixture(Action<IServiceCollection>? initialConfigureServices)
        {
        ...
        {
            return new CommissionTestContext<TStartup>(this);
        }
