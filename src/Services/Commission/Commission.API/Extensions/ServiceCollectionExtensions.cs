...
using AHAM.Services.Commission.API.Infrastructure.Filters;
...
namespace AHAM.Services.Commission.API.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCustomHealthCheck(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            builder.AddSqlServer(
                ...
                name: "commissiondb-check",
                tags: new[] { "commissiondb" });
            builder.AddRabbitMQ(
                $"amqp://{configuration["EventBusConnection"]}",
                name: "commission-rabbitmqbus-check",
        ...
        public static IServiceCollection AddCustomDbContext(this IServiceCollection services, IConfiguration configuration)
        {
            services
                ...
                .AddDbContext<CommissionContext>(options =>
                {
        ...
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Version = "v1",
                    Description = "The Commission Service HTTP API"
                });
        ...
        public static IServiceCollection AddCustomIntegrations(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<ICommissionIntegrationEventService, CommissionIntegrationEventService>();
